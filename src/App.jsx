...
export const blogLoader = async()=>{
  const blog = await axios.get("http://94.154.46.244:8080/blog/getblog")
  const users =await axios.get("http://94.154.46.244:8080/users/getuser")
...
const getBlog=async({params})=>{
  let blogs=[]
  await axios.get(`http://94.154.46.244:8080/blog/getblog/${params.id}`).then(res=>{
    blogs=res.data
  })
  return blogs
}
